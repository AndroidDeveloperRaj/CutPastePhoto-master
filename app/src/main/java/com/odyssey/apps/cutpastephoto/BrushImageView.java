...
public class BrushImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public BrushImageView(Context context) {
        ...
        this.smallRadious = (float) (this.density * 10);
    }
...
//            canvas.drawCircle(this.centerx, this.centery, this.smallRadious, p);
            ...
            //p.setColor(Color.argb(80, 128, 128, 128));
            ...
            canvas.drawCircle(this.centerx, this.centery, this.smallRadious-2, p);
...
//        canvas.drawCircle(this.centerx, this.centery - this.offset, this.width, p);
        ...
        p = new Paint();
        //p.setColor(Color.argb(this.alpga, 128, 128, 128));
        p.setColor(Color.TRANSPARENT);
        p.setAntiAlias(true);
        canvas.drawCircle(this.centerx, this.centery - this.offset, this.width, p);
        ...
        canvas.drawCircle(this.centerx, this.centery - this.offset, this.width-2, p);
